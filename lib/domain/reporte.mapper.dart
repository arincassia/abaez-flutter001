...
class ReporteMapper extends ClassMapperBase<Reporte> {
  ...
  static DateTime _$fecha(Reporte v) => v.fecha;
  static const Field<Reporte, DateTime> _f$fecha = Field('fecha', _$fecha);
...
abstract class ReporteCopyWith<$R, $In extends Reporte, $Out>
  ...
  $R call(
      {String? id, String? noticiaId, DateTime? fecha, MotivoReporte? motivo});
